---
title: "The First Three Questions to Ask Before Considering Any Digital System for Your Business"
date: 2024-07-18
lastmod: 2024-07-18
...
[An Accessibility Conformance Report (ACR) or completed Voluntary Product Accessibility Template (VPAT) (opens a new tab)](https://www.itic.org/policy/accessibility/vpat) is a standardized report. An ACR is a systematic report that goes through all major aspects of accessibility. [Here is what a completed ACR looks like (opens a new tab).](http:///acr) Do not accept:

-   [Accessibility Statement: (opens a new tab)](https://www.w3.org/WAI/planning/statements/) An accessibility statement is often hot air created by marketing and sales folks. It means nothing and helps you even less. The ACR is systematic and helps you know what you’re getting into. [A good accessibility statement will link to an Accessibility Conformance Report and give you the contact info for the head of accessibility (opens a new tab).](https://www.w3.org/WAI/planning/statements/)
-   Assurances the product is accessible. I don’t care how much the salesperson tells me their product is accessible. If the company didn’t take the time to systematically evaluate their tool for accessibility. If they didn’t see if it meets the most basic accessibility standards, they’re wasting my time. Salespeople will tell you their products are accessible, because why wouldn’t they be? Well, sadly, [95.9% of homepages have at least one accessibility error. These errors can be caught with an automated tool (opens a new tab).](https://webaim.org/projects/million/) This means 95.9% of the time you talk with a company, their product has major accessibility issues.
