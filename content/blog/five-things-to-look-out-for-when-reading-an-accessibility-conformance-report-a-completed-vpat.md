---
title: "Five Things to Look Out for When Reading an Accessibility Conformance Report (A Completed VPAT)"
date: 2024-02-19
lastmod: 2024-06-24
...
Look to see if the ACR was completed by a 3rd party company, not just the company making the product. Big names in accessibility like [Level Access (Opens in a new tab)](https://www.levelaccess.com/), [TPGi (Opens in a new tab)](https://www.tpgi.com/), or [Deque Systems (Opens in a new tab)](https://www.deque.com/) are good to see. For smaller companies, having a check done by an [independent accessibility expert (Opens in a new tab)](https://www.accessibilityassociation.org/s/certified-professional-directory) is also great. Internal ACRs are OK, but they should have the following:
...
Don’t just believe everything the ACR says. Try things out yourself. If the ACR says everything’s “supports”, use tools like the [AXE Chrome Plugin (Opens in a new tab)](https://chrome.google.com/webstore/detail/axe-devtools-web-accessib/lhdoppojpmngadmnindnejefpokejbdd) to see if that’s true. Remember, the actual experience of the app might not really match up with what they say in the ACR.
