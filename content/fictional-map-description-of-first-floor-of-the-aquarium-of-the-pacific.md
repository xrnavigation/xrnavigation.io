---
title: "Fictional Map Description of first floor of the Aquarium of the Pacific"
date: 2024-07-30
lastmod: 2025-08-21
slug: "fictional-map-description-of-first-floor-of-the-aquarium-of-the-pacific"
draft: false
---
...
The below is a fictionalized detailed version of the text description, based on [the First Floor of the Aquarium of the Pacific description from the UniDescription project (Opens a new tab).](https://unidescription.org/account/project/export/803) The below description expands on their description, clarifying and describing features at the space with fictional information. It also puts the description into the [landmark, route, and survey knowledge framework (opens a new tab).](/how-to-systematically-evaluate-the-text-accessibility-of-a-map-with-examples)

## Table of Contents

-   [Map Description of First Floor of the Aquarium of the Pacific](#map-description-of-first-floor-of-the-aquarium-of-the-pacific)
-   [Introduction](#introduction)
-   [Table of Contents](#table-of-contents)
-   [Synopsis](#synopsis)
-   [Landmarks](#landmarks)
-   [Great Hall of the Aquarium](#great-hall-of-the-aquarium)
    -   [Sensory Characteristics](#great-hall-sensory-characteristics)
    -   [Type](#great-hall-type)
    -   [Shape](#great-hall-shape)
    -   [Orientation](#great-hall-orientation)
    -   [Size](#great-hall-size)
-   [California and Baja Gallery](#california-and-baja-gallery)
    -   [Sensory Characteristics](#california-baja-sensory-characteristics)
    -   [Type](#california-baja-type)
    -   [Shape](#california-baja-shape)
    -   [Orientation](#california-baja-orientation)
    -   [Size](#california-baja-size)
-   [Seal and Sea Lion Underwater Viewing Tunnel](#seal-and-sea-lion-underwater-viewing-tunnel)
    -   [Sensory Characteristics](#seal-tunnel-sensory-characteristics)
    -   [Type](#seal-tunnel-type)
    -   [Shape](#seal-tunnel-shape)
    -   [Orientation](#seal-tunnel-orientation)
    -   [Size](#seal-tunnel-size)
-   [Main Entrance](#main-entrance)
    -   [Sensory Characteristics](#main-entrance-sensory-characteristics)
    -   [Type](#main-entrance-type)
    -   [Shape](#main-entrance-shape)
    -   [Orientation](#main-entrance-orientation)
    -   [Size](#main-entrance-size)
-   [Stairs](#stairs)
    -   [Sensory Characteristics](#stairs-sensory-characteristics)
    -   [Type](#stairs-type)
    -   [Shape](#stairs-shape)
    -   [Orientation](#stairs-orientation)
    -   [Size](#stairs-size)
-   [Elevator](#elevator)
    -   [Sensory Characteristics](#elevator-sensory-characteristics)
    -   [Type](#elevator-type)
    -   [Shape](#elevator-shape)
    -   [Orientation](#elevator-orientation)
    -   [Size](#elevator-size)
-   [Honda Blue Cavern exhibit](#honda-blue-cavern-exhibit)
    -   [Sensory Characteristics](#honda-blue-cavern-sensory-characteristics)
    -   [Type](#honda-blue-cavern-type)
    -   [Shape](#honda-blue-cavern-shape)
    -   [Orientation](#honda-blue-cavern-orientation)
    -   [Size](#honda-blue-cavern-size)
-   [Amber Forest exhibit](#amber-forest-exhibit)
    -   [Sensory Characteristics](#amber-forest-sensory-characteristics)
    -   [Type](#amber-forest-type)
    -   [Shape](#amber-forest-shape)
    -   [Orientation](#amber-forest-orientation)
    -   [Size](#amber-forest-size)
-   [Redondo Submarine Canyon exhibit](#redondo-submarine-canyon-exhibit)
    -   [Sensory Characteristics](#redondo-submarine-canyon-sensory-characteristics)
    -   [Type](#redondo-submarine-canyon-type)
    -   [Shape](#redondo-submarine-canyon-shape)
    -   [Orientation](#redondo-submarine-canyon-orientation)
    -   [Size](#redondo-submarine-canyon-size)
-   [Southern California Kelp Forest exhibit](#southern-california-kelp-forest-exhibit)
    -   [Sensory Characteristics](#southern-california-kelp-forest-sensory-characteristics)
    -   [Type](#southern-california-kelp-forest-type)
    -   [Shape](#southern-california-kelp-forest-shape)
    -   [Orientation](#southern-california-kelp-forest-orientation)
    -   [Size](#southern-california-kelp-forest-size)
-   [Southern Australia Kelp Forest exhibit](#southern-australia-kelp-forest-exhibit)
    -   [Sensory Characteristics](#southern-australia-kelp-forest-sensory-characteristics)
    -   [Type](#southern-australia-kelp-forest-type)
    -   [Shape](#southern-australia-kelp-forest-shape)
    -   [Orientation](#southern-australia-kelp-forest-orientation)
    -   [Size](#southern-australia-kelp-forest-size)
-   [Spiny Lobsters exhibit](#spiny-lobsters-exhibit)
    -   [Sensory Characteristics](#spiny-lobsters-sensory-characteristics)
    -   [Type](#spiny-lobsters-type)
    -   [Shape](#spiny-lobsters-shape)
    -   [Orientation](#spiny-lobsters-orientation)
    -   [Size](#spiny-lobsters-size)
-   [Abalone exhibit](#abalone-exhibit)
    -   [Sensory Characteristics](#abalone-sensory-characteristics)
    -   [Type](#abalone-type)
    -   [Shape](#abalone-shape)
    -   [Orientation](#abalone-orientation)
    -   [Size](#abalone-size)
-   [Breakwater exhibit](#breakwater-exhibit)
    -   [Sensory Characteristics](#breakwater-sensory-characteristics)
    -   [Type](#breakwater-type)
    -   [Shape](#breakwater-shape)
    -   [Orientation](#breakwater-orientation)
    -   [Size](#breakwater-size)
-   [Sea Jellies exhibit](#sea-jellies-exhibit)
    -   [Sensory Characteristics](#sea-jellies-sensory-characteristics)
    -   [Type](#sea-jellies-type)
    -   [Shape](#sea-jellies-shape)
    -   [Orientation](#sea-jellies-orientation)
    -   [Size](#sea-jellies-size)
-   [U-shaped path](#u-shaped-path)
    -   [Sensory Characteristics](#u-shaped-path-sensory-characteristics)
    -   [Type](#u-shaped-path-type)
    -   [Shape](#u-shaped-path-shape)
    -   [Orientation](#u-shaped-path-orientation)
    -   [Size](#u-shaped-path-size)
-   [Hall to the Elevator](#hall-to-the-elevator)
    -   [Sensory Characteristics](#hall-to-the-elevator-sensory-characteristics)
    -   [Type](#hall-to-the-elevator-type)
    -   [Shape](#hall-to-the-elevator-shape)
    -   [Orientation](#hall-to-the-elevator-orientation)
    -   [Size](#hall-to-the-elevator-size)
-   [Routes](#routes)
    -   [Main Entrance to the Outdoor Area](#main-entrance-to-the-outdoor-area)
    -   [Main Entrance to the Elevator](#main-entrance-to-the-elevator)
    -   [Main Entrance to the Stairs](#main-entrance-to-the-stairs)
-   [General Layout of the Space](#general-layout-of-the-space)
...
<script>
(function(){ function focusTarget(id){ var t=document.getElementById(id.replace(/^#/,'')); if(!t)return; if(!t.hasAttribute('tabindex'))t.setAttribute('tabindex','-1'); t.focus({preventScroll:true}); t.scrollIntoView({behavior:'smooth',block:'start'}); } document.querySelectorAll('#toc-nav a[href^="#"]').forEach(function(a){ a.addEventListener('click',function(e){ var id=this.getAttribute('href');if(!id||id==='#')return; if(!document.getElementById(id.slice(1)))return; e.preventDefault(); focusTarget(id); if(history.pushState){history.pushState(null,'',id);}else{location.hash=id;} }); }); window.addEventListener('hashchange',function(){ if(location.hash)focusTarget(location.hash); }); if(location.hash)focusTarget(location.hash); })();
</script>
